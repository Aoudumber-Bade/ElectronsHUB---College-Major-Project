...
<body id="table">
    ...
    <div id="main">
        ...
        <div id="main-content">
            ...
            <div id="top-nav">
                <p class="logo-text">Contact Forms</p>
                <div class="pro-box">
                <p>Welcome,
             ...
             <div class="forms-container">
                ...
                <div class="table-wrapper">
                    <table class="bordered-table">
                        ...
                        $offset = ($page - 1) * $limit;
                        $query = "SELECT * FROM contact Where 1 LIMIT {$offset}, {$limit}";
                        ...
                        if ($total != 0) {
                          ...
                          while ($result = mysqli_fetch_assoc($data)) {
                            ...
                            <tr>
                                ...
                                <td>" . $result['name'] . "</td>
                                <td>" . $result['email']. "....</td>
                                <td>" . substr($result['subject'],0,60) . "</td>
                ...
                <?php
                  ...
                  $pagination = "SELECT * FROM contact WHERE 1";
                ...
                <div class="pagination-container">
                  <div class="pagination-left">
                    <?php if($page>1){ ?>
                    <a href="contact_table.php?page=<?php echo $page-1; ?>" class="">&lt;</a>
                    <?php } ?>
                  </div>
                  ...
                  <div class="pagination-num">
                    ...
                    ?>
                    <a href="contact_table.php?page=<?php echo $i; ?>" class=""><?php echo $i; ?></a>
                    <?php } ?>
                  </div>
